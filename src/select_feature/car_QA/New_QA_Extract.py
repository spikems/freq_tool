...
class NewQAExtractWord(object):
    ...
    def integrate_search(self, question):
        ...
        for num in range(word_list_lenght):
            # print num, pos_word_data[num][0], pos_word_data[num][1]
    ...
    def extract_master(self, question, class_type):
        ...
        result_dict = {'question': question, 'brand': brand_word_list, 'product': product_word_list,
                       'attribute': attribute_word_list,'component': component_word_list, 'evaluation': evaluation_word_list,
                       'service': service_word_list, 'qword': query_word, 'is_contrast': class_type}
        # print 'component_word_list:', component_word_list
        # print 'attribute_word_list:', attribute_word_list
        return brand_word_list, product_word_list, component_word_list, attribute_word_list, evaluation_word_list, service_word_list, query_word
        # return result_dict
if __name__ == '__main__':
    ext_obj = NewQAExtractWord()
    question = '想了解是否需要给小六喷底盘装甲'
    # question = '请问各位的机油尺看的清楚吗？'
    ss = ext_obj.extract_master(question, 1)
    print ss
